...
public class ModelTest {
	public static void main(String[] args) {
		...
		System.out.println("Two Class strategy revenue: $" + modelprocess.getRevenue(flights));

		modelprocess.setModel(model3);
		System.out.println("Multi Class strategy revenue: $" + modelprocess.getRevenue(flights));
